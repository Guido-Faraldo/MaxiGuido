...
const mensajeLimiteCantidad = document.getElementById("mensajeErrorCantidad");
...
botonSumar.addEventListener("click", () => {
    if (categorias.length >= 6) {
        botonSumar.classList.add("sinHover");
        mostrarMensajeError("Error, solo se pueden ingresar hasta 6 categorias", mensajeLimiteCantidad)
    } else {
